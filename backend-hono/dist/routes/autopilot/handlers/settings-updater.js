...
export async function updateSettingsField(userId, field, value) {
...
export async function ensureSettingsExists(userId) {
    await sql `
...
export async function getUpdatedSettings(userId) {
...
//# sourceMappingURL=settings-updater.js.map