 ...
 */
export async function scoreNewsWithPriceBrain(newsItem, userInstrument) {
    try {
 ...
 */
export async function scoreNewsBatch(newsItems, userInstrument) {
...
//# sourceMappingURL=price-brain-service.js.map