...
export async function handleCalculateScore(c: Context) {
...
export async function handleGetScore(c: Context) {
  const userId = c.get('userId');
...
export async function handleGetCurrentScore(c: Context) {
  const userId = c.get('userId');
...
export async function handleGetScoreHistory(c: Context) {
  const userId = c.get('userId');
