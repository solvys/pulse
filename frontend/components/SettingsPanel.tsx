              ...
              <div key="trading" className={tabTransitioning && prevTab ? 'animate-fade-out-tab' : 'animate-fade-in-tab'}>
                ...
                <section className="pt-6 border-t border-zinc-800">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-[#FFC038] mb-3">Volatility Strategies</h4>
                      <div className="space-y-3">
                        <Toggle
                          label="22 VIX Fix"
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-[#FFC038] mb-3">Risk Event-Based Strategies</h4>
                      <div className="space-y-3">
                        <Toggle
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-[#FFC038] mb-3">Mean Reversion</h4>
                      <div className="space-y-3">
                        <Toggle
